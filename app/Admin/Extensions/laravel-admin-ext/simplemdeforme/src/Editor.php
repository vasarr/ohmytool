...
class Editor extends Field
{
     ...
     * @var string
     */
//    protected $view = 'laravel-admin-simplemdeforme::simplemde';

    /**
     * @var array
     */
    protected static $css = [
        'vendor/laravel-admin-ext/simplemdeforme/dist/simplemde.min.css',
    ];
     ...
     */
    protected static $js = [
        'vendor/laravel-admin-ext/simplemdeforme/dist/simplemde.min.js',
        'vendor/laravel-admin-ext/simplemdeforme/dist/inline-attachment.min.js',
        'vendor/laravel-admin-ext/simplemdeforme/dist/codemirror.inline-attachment.js',
    ];
